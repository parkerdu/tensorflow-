...
# 使用梯度下降法
train_step = tf.train.AdamOptimizer(0.0001, 0.9).minimize(loss)
...
with tf.Session() as sess:
    ...
    for epoch in range(31):
        for batch in range(n_batch):
            ...
            sess.run(train_step, feed_dict={x:batch_xs, y:batch_ys, keep_prob:0.7})  # 每一层70%神经元工作
        ...
        print('Period'+str(epoch)+',Test Accuracy'+str(test_acc)+ ',train Accuracy' + str(train_acc))
